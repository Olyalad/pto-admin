...
<style type="text/css">
    ...
    .main_wrapper {
        ...
        z-index: 100;
        position: fixed;
        /*background-image: url('./img/Stamp.png') no-repeat;*/
    ...
    .podpis {
        ...
        z-index: 10;
        position: fixed;
        /*background-image: url('./img/podpis2.png') no-repeat;*/
        background-position: -30% 30%;
        background-size: contain;
        right: 380px;
        bottom: 35px;
...
<div class='main_wrapper'><?= Html::img('./img/Stamp.png', ['width' => '200', 'height' => '200']) ?></div>
<div class="podpis"><?= Html::img('./img/podpis2.png', ['width' => '80', 'height' => '80']) ?></div>
<div style="width:50%; overflow:hidden; float:left; position: relative; z-index:50;">

    <table width="100%">
        <tr>
            <td class="noborder" align="center">
                <div style="font-size: 11px;"><b>Диагностическая карта<b></div>
                <div style="font-size: 11px;"><b>Certificate of periodic technical inspection</b></div>
                <table cellpadding="2" cellspacing="0" border="0" width="70%">
                    <tr>
                        <td class="noborder">
                            <div style="font-size: 8px;"><b>Регистрационный номер</b></div>
                        </td>
                        <td class="noborder"><?= $eisto_bordered ?></td>
                        <td class="noborder" style="font-size: 8px;"><b>срок действия</b></td>
    ...
    <table cellpadding="0" cellspacing="0" width="520px">
        ...
        <tr>
            ...
            <td colspan="5" style="font-size:8px">Категория ТС: B <b><?= $model->kat1 ?></b></td>
        </tr>
        <tr>
    ...
    <table cellpadding="0" cellspacing="0" width="520px" style="font-size: 8px;">
        <tr align="center" height="10">
            <td style="width: 30px; text-align:center; font-size: 8px; font-weight: bold;">№</td>
            <td style="font-size: 5px;">Параметры и требования, предъявляемые к транспортным средствам при проведении
        ...
        <tr align="center" height="10">
            <td colspan="3" style="font-size: 8px; text-align:center; font-weight: bold; height: 30px;">I. Тормозные
                системы
            </td>
            <td colspan="3" style="font-size: 8px; text-align:center; font-weight: bold;">IV. Стеклоочистители и
                стеклоомыватели
            </td>
            <td class="number" style="font-size: 8px; font-weight: bold;">46</td>
            <td class="main_text" align="left">Наличие работоспособного звукового сигнального
                прибора
            </td>
            <td></td>
        </tr>
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Соответствие показателей эффективности торможения и устойчивости
                торможения
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">24</td>
            <td class="main_text" align="left">Наличие и работоспособность предусмотренных изгот.
            ...
            <td class="main_text" align="left">Наличие обозначений аварийных выходов и табличек по
        ...
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Соответствие разности тормозных сил установленным
                требованиям
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">25</td>
            <td class="main_text" align="left">Обеспечение стеклоомывателем подачи жидкости в
                зоны очистки стекла
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">48</td>
            <td class="main_text" align="left">Наличие задних и боковых защитных устройств,
        ...
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Работоспособность рабочей тормозной системы
            ...
            <td class="main_text" align="left">Работоспособность стеклоочистителей и
                стеклоомывателей
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">49</td>
            <td class="main_text" align="left">Раб-ть автоматического замка, ручной и автоматической
        ...
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Отсутствие утечек сжатого воздуха из колесных
                тормозных камер
            </td>
            <td style="text-align:center;">-</td>
            <td colspan="3" style="font-size: 8px; text-align:center; font-weight: bold;">V. Шины и колеса</td>
            <td class="number" style="font-size: 8px; font-weight: bold;">50</td>
            <td class="main_text" align="left">Наличие раб-ных предохранительных приспособлений у
        ...
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Отсутствие подтеканий тормозной жидкости, нарушения
            ...
            <td class="main_text" align="left">Соответствие высоты рисунка протектора шин
                установленным требованиям
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">51</td>
            <td class="main_text" align="left">Оборуд. прицепов (за искл. одноосных и роспусков)
        ...
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Отсутствие коррозии, грозящей потерей герметичности
                или разрушением
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">28</td>
            <td class="main_text" align="left">Отсутствие признаков непригодности шин к эксплуатации</td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">52</td>
            <td class="main_text" align="left">Отсутствие продольного люфта в беззазорных тягово-
        ...
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Отсутствие механических повреждений тормозных
                трубопроводов
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">29</td>
            <td class="main_text" align="left">Наличие всех болтов или гаек крепления дисков и
                ободьев колес
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">53</td>
            <td class="main_text" align="left">Обеспечение тягово-сцепными устройствами легковых
        ...
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Отсутствие трещин остаточной деформации деталей тормозного привода</td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">30</td>
            <td class="main_text" align="left">Отсутствие трещин на дисках и ободьях колес</td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">54</td>
            <td class="main_text" align="left">Соответствие размерных характеристик сцепных
        ...
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Исправность средств сигнализации и контроля тормозных систем</td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">31</td>
            <td class="main_text" align="left">Отсутствие видимых нарушений формы и размеров
                крепежных отверстий в дисках колес
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">55</td>
            <td class="main_text" align="left">Оснащение транспортных средств исправными ремнями
                безопасности
            </td>
            <td></td>
        </tr>
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Отсутствие набухания тормозных шлангов под давлением, трещин и видимых
                мест перетирания
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">32</td>
            <td class="main_text" align="left">Установка шин на транспортное средство в соответствии
                с требованиями
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">56</td>
            <td class="main_text" align="left">Наличие знака аварийной остановки и медицинской
                аптечки
            </td>
            <td></td>
        </tr>
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Расположение и длина соединительных шлангов пневматического тормозного
                привода автопоездов
            </td>
            <td style="text-align:center;">-</td>
            <td colspan="3" style="font-size: 8px; text-align:center; font-weight: bold;">VI. Двигатель и его системы
            </td>
            <td class="number" style="font-size: 8px; font-weight: bold;">57</td>
            <td class="main_text" align="left">Наличие не менее двух противооткатных упоров</td>
            <td style="text-align:center;">-</td>
        </tr>
        <tr align="center">
            <td colspan="3" style="font-size: 8px; text-align:center; font-weight: bold; height: 30px;">II. Рулевое
                управление
            </td>
            <td class="number" style="font-size: 8px; font-weight: bold;">33</td>
            <td class="main_text" align="left">Соответствие содержания загрязняющих веществ в
                отработавших газах транспортных средств
                установленным требованиям
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">58</td>
            <td class="main_text" align="left">Наличие огнетушителей, соответствующих
                установленным требованиям
            </td>
            <td></td>
        </tr>
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Работоспособность усилителя рулевого управления. Плавность изменения
                усилия при повороте рулевого колеса
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">34</td>
            <td class="main_text" align="left">Отсутствие подтекания и каплепадения топлива в
                системе питания
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">59</td>
            <td class="main_text" align="left">Надежное крепление поручней в автобусах, запасного
        ...
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Отсутствие самопроизвольного поворота рулевого колеса с усилителем
            ...
            <td class="main_text" align="left">Работоспособность запорных устройств и устройств
                перекрытия топлива
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">60</td>
            <td class="main_text" align="left">Работоспособность механизмов регулировки сидений</td>
            <td></td>
        </tr>
        <tr align="center" height="10">
            <td class="number" style="font-size: 8px; font-weight: bold;">14</td>
            <td class="main_text" align="left">Отсутствие превышения предельных значений суммарного люфта в рулевом
                управлении
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">36</td>
            <td class="main_text" align="left">Соответсвие системы питания газобаллнонных ТС, ее
                размещение и установки установленным требованиям
            </td>
            <td style="text-align:center;">-</td>
            <td class="number" style="font-size: 8px; font-weight: bold;">61</td>
            <td class="main_text" align="left">Наличие надколесных грязезащитных устройств,
        ...
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Отсутствие повреждения и полная комплектность деталей крепления рулевой
                колонки и картера рулевого механизма
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">37</td>
            <td class="main_text" align="left">Соответствие нормам уровня шума выпускной системы</td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">62</td>
            <td class="main_text" align="left">Соответствие вертикальной статической нагрузки на
        ...
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Отсутствие следов остаточной деформации, трещин и других дефектов в
                рулевом механизме и рулевом приводе
            </td>
            <td></td>
            <td colspan="3" style="font-size: 8px; text-align:center; font-weight: bold;">VII. Прочие элементы
                конструкции
            </td>
            <td class="number" style="font-size: 8px; font-weight: bold;">63</td>
            <td class="main_text" align="left">Работоспособность держателя запасного колеса,
        ...
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Отсутствие устройств, ограничивающих поворот рулевого
                колеса, не предусмотренных конструкцией
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">38</td>
            <td class="main_text" align="left">Наличие зеркал заднего вида в соответствии с
                требованиями
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">64</td>
            <td class="main_text" align="left">Работоспособность механизмов подъема и опускания
                опор и фиксаторов транспортного положения опор
            </td>
            <td style="text-align:center;">-</td>
        </tr>
        <tr align="center" style="height: 80px;">
            <td colspan="3" style="font-size: 8px; text-align:center; font-weight: bold;">III. Внешние световые
                приборы
            </td>
            <td class="number" style="font-size: 8px; font-weight: bold;">39</td>
            <td class="main_text" align="left">Отс. доп. предметов или покрытий, огранич. обзорность
            ...
            <td class="main_text" align="left">Отсутствие каплепадения масел и рабочих жидкостей</td>
            <td></td>
        </tr>
        <tr align="center" height="10">
            <td class="number" style="font-size: 8px; font-weight: bold;">18</td>
            <td class="main_text" align="left">Соответствие устройств освещения и световой сигнализации установленным
                требованиям
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">40</td>
            <td class="main_text" align="left">Соответствие норме светопропускания ветрового стекла,
                передних боковых стекол и стекол передних дверей
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">66</td>
            <td class="main_text" align="left">Установка государственных регистрационных знаков в
        ...
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Отсутствие разрушений рассеивателей световых приборов</td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">41</td>
            <td class="main_text" align="left">Отсутствие трещин на ветровом стекле в зоне очистки
                водительского стеклоочистителя
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">67</td>
            <td class="main_text" align="left">Работоспособность устройства или системы вызова
        ...
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Работоспособность и режим работы сигналов торможения</td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">42</td>
            <td class="main_text" align="left">Раб-ть замков дверей кузова, кабины, мех. регулировки и фиксирующих
            ...
            <td class="main_text" align="left">Отсутствие изменений в конструкции ТС, внесенных в
        ...
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Соответствие углов регулировки и силы света фар установленным
                требованиям
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">43</td>
            <td class="main_text" align="left">Работоспособность запоров бортов грузовой платформы
                и запоров горловин цистерн
            </td>
            <td style="text-align:center;">-</td>
            <td class="number" style="font-size: 8px; font-weight: bold;">69</td>
            <td class="main_text" align="left">Соответствие ТС установленным дополнительным
                требованиям
            </td>
            <td style="text-align:center;">-</td>
        </tr>
        <tr align="center" height="10">
            ...
            <td class="main_text" align="left">Наличие и расположение фар и сигнальных фонарей в местах, предусмотренных
                конструкцией
            </td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">44</td>
            <td class="main_text" align="left">Работоспособность аварийного выключателя дверей и
                сигнала требования остановки
            </td>
            <td style="text-align:center;">-</td>
            <td></td>
            <td class="main_text" align="left"></td>
            <td></td>
        </tr>
        <tr align="center" height="10">
            <td class="number" style="font-size: 8px; font-weight: bold;">23</td>
            <td class="main_text" align="left">Соответствие источника света в фарах</td>
            <td></td>
            <td class="number" style="font-size: 8px; font-weight: bold;">45</td>
            <td class="main_text" align="left">Работоспособность аварийных выходов, приборов внутреннего освещения
...
<div style="width:50%; float:right; position: relative; z-index: 50">
    <div style="font-size: 11px; text-align:center; font-weight: bold;">Результаты диагностирования</div>
    <table cellpadding="2" cellspacing="0" width="520px">
        <tr>
    ...
    <table cellpadding="2" cellspacing="0" width="100%">
        <tr>
            ...
            <td class="little_text" width="50%">Заключение о возможности/невозможности<br> эксплуатации транспортного
                средства <br>Results of the roadworthiness inspection
            </td>
            <td align="center">
    ...
    <table cellpadding="2" cellspacing="0" width="100%">
        <tr height="70" valign="top">
            <td class="little_text" width="70%" style="height: 35px; vertical-align: top;"><b>Пункты диагностической
                    карты, требующие повторной проверки:</b></td>
            <td></td>
        </tr>
    </table>
    <table cellpadding="2" cellspacing="0" width="100%">
        <tr height="90" valign="top">
            <td>
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td class="noborder little_text" width="50%"><b>Технический эксперт: Андриянов Андрей
